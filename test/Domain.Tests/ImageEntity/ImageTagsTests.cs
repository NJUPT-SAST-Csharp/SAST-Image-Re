...
public class ImageTagsTests
{
    ...
    {
        long[] imageTags_more_than_MaxCount = Enumerable
    ...
    public void Return_True_When_Create_From_Valid()
    {
        ...
        long[] valid_ImageTags = Enumerable
            .Range(default, ImageTags.MaxCount - 1)
            .Select(index => (long)index)
            .ToArray();
    ...
    public void Return_True_When_Count_Valid_After_Remove_Duplicate()
    {
        ...
        long[] total_imageTags = imageTags_less_than_MaxCount.Concat(duplicate_imageTags).ToArray();
    ...
    public void Should_Not_Contain_Duplicate_ImageTags()
    {
        ...
        long[] imageTags_with_duplicate_ones = Enumerable
    ...
    {
        long[] empty_imageTags = ImageTags.Empty.Select(i => i.Value).ToArray();
    ...
    {
        long[] maxcount_imageTags = Enumerable
