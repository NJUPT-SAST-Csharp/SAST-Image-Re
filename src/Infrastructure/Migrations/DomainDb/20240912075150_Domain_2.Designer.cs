...
namespace Infrastructure.Migrations.DomainDb
{
    ...
    [Migration("20240912075150_Domain_2")]
            ...
            modelBuilder.Entity("Domain.UserDomain.UserEntity.User", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("_password", "Domain.UserDomain.UserEntity.User._password#Password", b1 =>
                        {
