...
namespace Application.ImageServices.Queries
{
    ...
    public sealed record DetailedImageQuery(ImageId Image, Actor Actor)
        : IQueryRequest<DetailedImage?>;
    ...
    {
        private readonly IQueryRepository<DetailedImageQuery, DetailedImage?> _repository =
            repository;
