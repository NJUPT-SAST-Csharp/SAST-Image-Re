...
public sealed record RegisterCommand(Username Username, PasswordInput Password, RegistryCode Code)
...
{
    public async Task<JwtValue> Handle(RegisterCommand command, CancellationToken cancellationToken)
    {
        await Task.WhenAll(
